...
public class TelaDeCadastro extends JFrame{
    ...
    public TelaDeCadastro(){
        ...
        btnCadastrar.setPreferredSize(new Dimension(40, 40));
        ...
        lblNotificacoes = new JLabel("DESAINI RE-EXPANSIVO", SwingConstants.CENTER);
        linhaNotificacoes.add(lblNotificacoes);
        add(linhaNotificacoes);

        // PARTE DA AULA QUE FALTEI
        ...
        public static void main(String[] args) {
            ...
            appTelaDeCadastro.setSize(300, 300);
